...
function processAndWriteBrandColors(sourceData, variableCollections, variables, tokenVariableCollection) {
      ...
      if (Object.keys(brandColors).length > 0) {
        ...
        ["light", "dark"].forEach((mode) => {
          ...
          fs.writeFileSync(
            ...
            JSON.stringify({ w: brandColors }, null, 2)
          );
        });
      }
    }
...
// Export the main function for processing colors
module.exports = {
